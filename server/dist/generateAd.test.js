...
describe('parsePrompt', () => {
    ...
    it('extracts colors', () => {
        ...
        expect(result.colors).toContain('#FF6B00'); // orange
        expect(result.colors).toContain('#212121'); // black
    });
...
describe('generateAdSpec', () => {
    ...
    it('generates Learn More CTA when no offer', () => {
        ...
        const spec = generateAdSpec(parsed);
        // With the new copy engine, CTA may be category-appropriate
    ...
    it('uses extracted colors as primary/secondary', () => {
        ...
        const spec = generateAdSpec(parsed);
        expect(spec.colors.primary).toBe('#FF6B00'); // orange
        expect(spec.colors.secondary).toBe('#1565C0'); // blue
    });
